...
//defining schema for username and password
...
function signJwt(username, password) {
  const userEmail = userNameSchema.safeParse(username);
  const userPassword = userPasswordSchema.safeParse(password);

  //following if is known as early return
